...
<head>
    ...
    <link rel="stylesheet" type="text/css" id="styles" href="/resources/css/painting_view.css" media="screen">
...
<!-- LOGO AND DESCRIPTION -->
   <div class="clearfix bottom-35">
    ...
    <div class="divider-text bottom-50">
        <span>Get to know all about painting</span>
    </div>

<div class=painting>
    <div id=painting-title>${painting.title}
      <sec:authorize access="hasRole('ADMIN')">
        <a href= "/edit/paintings/${painting.id}">edit</a>
      </sec:authorize>
    </div>
    <div id=painting-artist>  by <a href= "/artists/${painting.artist.id}">${painting.artist.name}</a> (${painting.dateMade})</div>
    ...
    <div id=painting-summary> <p>  ${painting.summary}</p> </div>
</div>
        ...
        ${painting.paintingGallery.owner}</a>
         ...
         <c:if test="${painting.paintingGallery.type=="PublicGallery"}">
            ...
            <div id="painting-owner-schedule">
                ...
                <p>Thursday: ${painting.paintingGallery.schedule.thursdayTime} </p>
                <p>Friday: ${painting.paintingGallery.schedule.fridayTime} </p>
                <p>Saturday: ${painting.paintingGallery.schedule.saturdayTime} </p>
                <p>Sunday: ${painting.paintingGallery.schedule.sundayTime} </p>
            </div>
        </c:if>
</div>
