...
<html>
   <head>
       ...
       <link rel="stylesheet" type="text/css" id="styles" href="/resources/css/artist_view.css" media="screen">
   ...
   <!-- LOGO AND DESCRIPTION -->
       <div class="clearfix bottom-35">
           ...
           <div class="divider-text bottom-50">
               <span>Get to know all about artist</span>
           </div>
    <div class="artist">
        <div class="artist-name"> ${artist.name}
            <sec:authorize access="hasRole('ADMIN')">
                <a href="/edit/artists/${artist.id}">edit</a>
            </sec:authorize>
        </div>
        ...
        <li class="col1-4">
            <div class="project">
                <div class="proj-img"><a href="${artist.image}" class="prettyPhoto zoom"></a> <a href="/artists/${artist.id}"></a> <img src="${artist.image}" alt=""></div>
            </div>
        </li>
    ...
    <ul id="portfolio" class="inner-960 bottom-15 clearfix">
      <div class="artist-paintings">
        <p>Paintings made by ${artist.name}:</p>
      </div>
